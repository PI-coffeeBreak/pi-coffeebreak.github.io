...
## 2. Example nginx configuration for production

[Download example nginx.conf](./nginx.conf)
...
## 3. Example `docker-compose.yml` (production)

[Download production docker-compose.yml](./docker-compose.prod.yml)

Below is a production example using the official images from GitHub Container Registry:
...
## 4. Example `docker-compose.yml` (development)

[Download development docker-compose.yml](./docker-compose.dev.yml)
...
## 7. How to get the `KEYCLOAK_CLIENT_SECRET`
